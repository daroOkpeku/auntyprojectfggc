...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; border-top: 30px solid transparent; border-right: 30px solid transparent; border-left: 30px solid transparent; border-bottom: 30px solid transparent; border-radius: 0; width: 640px;" width="640">
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="0" cellspacing="0" class="text_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
<tr>
<td class="pad" style="padding-left:50px;padding-right:40px;padding-top:35px;">
...
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;"><strong><span style="font-size:20px;">Message from <?php echo e($data['name']); ?></span></strong></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 12px; mso-line-height-alt: 21.6px; color: #555555; line-height: 1.8; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">Name:<?php echo e($data['name']); ?></p>
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">Email: <?php echo e($data['email']); ?></p>
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">message: <?php echo e($data['comments']); ?></p>
</div>
</div>
</td>
</tr>
...
<?php /**PATH C:\xampp\htdocs\dashboard\project\FGGC\resources\views\mail\contact.blade.php ENDPATH**/ ?>