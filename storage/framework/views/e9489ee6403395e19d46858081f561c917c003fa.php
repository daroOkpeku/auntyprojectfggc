...
<div>
    ...
    <section class="relative lg:py-24 py-16">
                ...
                <div class="lg:col-span-5 md:col-span-6">
                    <div class="lg:ml-5">
                        <div class="bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-700 p-6">
                            ...
                            <h3 class="mb-6 text-lg text-center leading-normal font-medium zoex"></h3>
        ...
        <div class="container lg:mt-24 mt-16">
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[14px]">
                ...
                <div class="text-center px-6">
                    ...
                    <div class="content mt-7">
                        <h5 class="title h5 text-xl font-medium">Facebook</h5>
                        <p class="text-slate-400 mt-3">FGGC Owerri Alumnae Official  </p>

                        <div class="mt-5">
                            <a href="https://www.facebook.com/groups/1801457053315708/" class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">"https://www.facebook.com/groups/1801457053315708"</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center px-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <div class="mt-5">
                            <a href="mailto:fggcowerrioga@yahoo.com " class="btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">fggcowerrioga@yahoo.com </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center px-6">
                    ...
                    <div class="content mt-7">
                        <h5 class="title h5 text-xl font-medium">Twitter</h5>
                        <p class="text-slate-400 mt-3">FGGC Owerri Alumnae Official  </p>

                        <div class="mt-5">
                            <a
                            data-type="iframe" class="video-play-icon read-more lightbox btn btn-link text-green-600 hover:text-green-600 after:bg-green-600 transition duration-500">@FggcOld</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center px-6">
                    ...
                    <div class="content mt-7">
                        <h5 class="title h5 text-xl font-medium">Instagram</h5>
                        <p class="text-slate-400 mt-3">FGGC Owerri Alumnae Official  </p>
    ...
    <script>
        ...
        let zoex = document.querySelector(".zoex")
        ...
        submit.addEventListener("click", function(e){
            ...
            let url = `${original}/contact`;
            axios.post(url, formData, headers).then(res=>{
               if(res.data.success){
                zoex.innerText = res.data.success
                zoex.style.color = "green"
                ...
                if(error.email){
                    zoex.innerText =  error.email[0]
                    zoex.style.color = "red"
                }else if(error.name){
                    zoex.innerText =  error.name[0]
                    zoex.style.color = "red"
                }else if(error.comments){
                    zoex.innerText =  error.comments[0]
                    zoex.style.color = "red"
                }
             })
        })
...
<?php echo $__env->make('layout.headtwo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\project\FGGC\resources\views/contact.blade.php ENDPATH**/ ?>