...
<head>
        ...
        <script defer type="module" src="<?php echo e(asset('asset/js/chapter.js')); ?>" ></script>
        ...
        <script defer type="module"  src="<?php echo e(asset('asset/js/infogallery.js')); ?>" ></script>
         <script defer src="<?php echo e(asset('asset/js/blog.js')); ?>" ></script>
        <script type="module" src="<?php echo e(asset('asset/js/blogdetail.js')); ?>" ></script>
