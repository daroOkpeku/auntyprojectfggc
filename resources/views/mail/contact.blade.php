...
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;"><strong><span style="font-size:20px;">Message from {{ $data['name'] }}</span></strong></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">Name:{{ $data['name'] }}</p>
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">Email: {{ $data['email'] }}</p>
<p style="margin: 0; font-size: 12px; mso-line-height-alt: 21.6px; letter-spacing: 1px;">message: {{ $data['comments'] }}</p>
</div>
</div>
</td>
</tr>
